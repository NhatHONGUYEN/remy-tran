  ...
  return (
    <div className="w-full h-screen flex relative p-32  ">
      ...
      <div className="text-4xl font-thin absolute w-2/5 bottom-56 right-80 ">
        ...
        >
          I started my motion adventure in 2015 passing through various project
          and challenges like Videomapping, Architecture viz, Explainer video
          and even opening credits for a music video!
        </motion.p>
        <motion.p
          initial={{ opacity: 0 }}
          whileInView={{ opacity: 1 }}
